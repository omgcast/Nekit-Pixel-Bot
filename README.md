...
![Status](https://img.shields.io/badge/Status-BETA-orange?style=for-the-badge) ![WoW](https://img.shields.io/badge/WoW-7.3.5%20%7C%208.3.7%20%7C%209.2.7%20%7C%2010.2.7-red?style=for-the-badge) ![Platform](https://img.shields.io/badge/Platform-Windows-blue?style=for-the-badge)

Tested (wip)

10.2.7 firestorm-servers.com, ...

9.2.7: wowcircle.net, ...

8.3.7: wowcircle.net, ...

7.3.5: uwow.biz, wowcircle.net, ... 

**Nekit Pixel Bot** is an external automation tool designed for **World of Warcraft 7.3.5 (Legion)**,  **8.3.7 (Battle for Azeroth)**, **World of Warcraft 9.2.7 (Shadowlands)**, **World of Warcraft 10.2.7 (Dragonflight)**. It works in conjunction with a modified version of the **Hekili** addon.

> ⚠️ **BETA VERSION** This software is currently in Beta.
> 
...
2.  **Keybindings:** Ensure your action bars use standard keys: `1`-`9`, `0`, `-`, `=`, `Q`, `E`, `R`, `F`, `Z`, `X`, `C`, `V`.
...
2.  **Клавиши:** Бот нажимает стандартные клавиши: `1`-`9`, `0`, `-`, `=`, `Q`, `E`, `R`, `F`, `Z`, `X`, `C`, `V`. Расставьте способности в игре на эти кнопки.
